...
print(book)  # Display book information
print(f"Reading time: {Book.calculate_reading_time(book.get_pages())} minutes")  # Calculate and display reading time

ebook = Ebook("The Great Gatsby", "F. Scott Fitzgerald", 180, "EPUB")
print(ebook)  # Display ebook information
print(f"Reading time: {Book.calculate_reading_time(ebook.get_pages())} minutes")  # Calculate and display reading time
